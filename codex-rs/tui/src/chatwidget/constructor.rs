...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let mut widget = Self {
            ...
            jobs: super::jobs::JobsState::default(),
            context_inspection: super::context_inspection::ContextInspectionState::default(),
            recovery: super::recovery::RecoveryState::default(),
